...
const helpSections = [
      ...
      <div className="bg-secondary border border-border p-4 rounded-lg">
        ...
        <div className="space-y-2 text-sm text-muted-foreground">
          ...
          <ul className="ml-6 list-disc space-y-1">
            <li>The token is <strong>used only once</strong> for your first login</li>
            <li>During first login, the token is <strong>permanently linked to your email address</strong></li>
  ...
  {
    title: "Tracking Guest Responses",
    content: (
      <div>
...
function HelpSection({ section, index }: { section: typeof helpSections[0]; index: number }) {
  return (
    <motion.div
...
export function HelpCenterDialog({ open, onOpenChange }: HelpCenterDialogProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogTitle className="sr-only">Event RSVP Platform - Help Center</DialogTitle>
        <div>
          {/* Header */}
          <motion.div 
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                Event RSVP Platform - Help Center
              </motion.h2>
              <motion.p 
              ...
              >
                Create beautiful digital invitations with seamless RSVP management for all your events
              </motion.p>
            </div>
          </motion.div>
